...
namespace MudBlazorThemes.UI.Extensions
{
    public class Extensions
    {
        ...
        /// <summary>
        /// Return the current MudMarkdown version
        /// </summary>
        public static string MudMarkdownVersion => typeof(MudMarkdown).Assembly.GetName().Version?.ToString() ?? string.Empty;
    }
}
