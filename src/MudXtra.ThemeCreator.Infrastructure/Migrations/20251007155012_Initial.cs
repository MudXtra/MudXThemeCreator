        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomThemeId = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Default = table.Column<int>(type: "int", nullable: false),
                    Min = table.Column<int>(type: "int", nullable: false),
                    Max = table.Column<int>(type: "int", nullable: false),
                    CssVariable = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomThemeId = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Default = table.Column<string>(type: "nvarchar(125)", maxLength: 125, nullable: false),
                    CssVariable = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OtherText = table.Column<string>(type: "nvarchar(199)", maxLength: 199, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomThemeId = table.Column<int>(type: "int", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    TypoType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    DataType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Default = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    CssVariable = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MappedThemeId = table.Column<int>(type: "int", nullable: false),
                    NativeCssVariable = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MappedCssVariable = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThemeOptionId = table.Column<int>(type: "int", nullable: true),
                    ThemeName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ThemeType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    LightValue = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    DarkValue = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CssVariable = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxThemes = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "CustomThemes",
                columns: new[] { "Id", "CreatedWhen", "IsActive", "IsApproved", "Name", "OtherText", "UploadedBy" },
                values: new object[] { 1, new DateTime(2025, 1, 1, 6, 0, 0, 0, DateTimeKind.Utc), true, true, "MudBlazor Default Theme", "The Default Theme for MudBlazor", null });
