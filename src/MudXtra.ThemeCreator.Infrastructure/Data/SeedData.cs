...
namespace MudXtra.ThemeCreator.Infrastructure.Data
{
    public class SeedData
    {
        ...
        public static List<CustomTheme> GetCustomThemes()
        {
            return
            [
                new CustomTheme{ Id = 1, IsActive = true, IsApproved = true, Name = "MudBlazor Default Theme", CreatedWhen = new DateTime(2025,1,1).ToUniversalTime(), OtherText = "The Default Theme for MudBlazor" }
            ];
        }
