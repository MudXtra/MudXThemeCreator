...
## I want X theme for easy export

Fill this out for your theme and post it as an issue. I'll evaluate it and add it to the site if it's a good fit. If you are importing this theme from some other tool, application, or Git repository, please provide a link to the source and the license. Include credit, they worked hard on it! Do not adjust the ID's, I will adjust those when/if I import them.
...
```csharp
    public class ThemeData // Name Here
    {
        ...
        public static List<CustomTheme> GetCustomThemes()
        {
            return
            [
                new CustomTheme{ Id = 1, IsActive = true, IsApproved = true, Name = "Name Theme", CreatedWhen = DateTime.Now, OtherText = "The Name Theme for MudBlazor" }
            ];
        }
